...
\TLabel{AssignWorld}
\UnaryInfC{$\Omega, \Pi, \Sigma \vdash \assgncom{u}{\hypwrld{c}} : \Omega \cup \{u\}$}
\end{prooftree}
...
\BinaryInfC{$\config{n.v, \sigma, \omega, \pi, \rho, \eta, \mu} \Downarrow s$}
\end{prooftree}
...
\RightLabel{$\textsc{Weight}$}
\TrinaryInfC{$\config{u.n.v, \sigma, \omega, \pi, \rho, \eta, \mu} \Downarrow s$}
\end{prooftree}
