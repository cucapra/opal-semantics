...
\begin{prooftree}
\AxiomC{$\Omega, \Sigma \vdash b : \textsc{Bool}$}
\AxiomC{$\Omega, \Pi, \Sigma, H \vdash c_1 : \Omega'$}
\AxiomC{$\Omega, \Pi, \Sigma, H \vdash c_2 : \Omega''$}
...
\begin{prooftree}
\AxiomC{$\Omega, \Pi, \Sigma, H \vdash w : \textsc{World}$}
\UnaryInfC{$\Omega, \Pi, \Sigma, H \vdash \assgncom{u}{w} : \Omega \cup \{u\}$}
\end{prooftree}

\begin{prooftree}
\AxiomC{$\Omega, \Pi, \Sigma, H \vdash \hypwrld{c} : \textsc{World}$}
\UnaryInfC{$\Omega, \Pi, \Sigma, H \vdash \commitcom{\hypwrld{c}} : \Omega$}
\end{prooftree}

\begin{prooftree}
\AxiomC{$\Omega, \Pi, \Sigma, H \vdash u : \textsc{World}$}
...
\AxiomC{$(n, v) \in \Sigma$}
\AxiomC{$\Omega, \Pi, \Sigma, H \vdash w : \textsc{World}$}
\BinaryInfC{$\Omega, \Sigma \vdash w.n.v : \textsc{Sexp}$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{$\varnothing, \Pi, \Sigma, H \vdash \commitcom{\hypwrld{c}} : \Omega'$}
\UnaryInfC{$\Omega, \Pi, \Sigma, H \vdash \hypwrld{c} : \textsc{World}$}
\end{prooftree}

\begin{prooftree}
\AxiomC{$u \in \Omega$}
\UnaryInfC{$\Omega, \Pi, \Sigma, H \vdash u : \textsc{World}$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{$\config{w, (\sigma, \Sigma), \omega, \pi, \rho, \eta, \mu} \Downarrow \sigma_{hyp}$}
\RightLabel{$\textsc{Hyp}$}
\UnaryInfC{$\config{\assgncom{u}{w}, (\sigma, \Sigma), \omega, \pi, \rho, \eta, \mu} \Downarrow \config{\sigma, \omega[u \mapsto (\sigma, \sigma_{hyp})]}$}
\end{prooftree}
...
\RightLabel{$\textsc{Hyp}$}
\UnaryInfC{$\config{\assgncom{u}{w}, (\sigma, \Sigma), \omega, \pi, \rho, \eta, \mu} \Downarrow \config{\sigma, \omega[u \mapsto ((\sigma, \Sigma), \sigma')]}$}
\end{prooftree}
